...
import mx.uaemex.fi.ico.linc26.estacionamiento.admin.view.LogTable;
...
public class ExploreLogsController implements IControllerFX {
	...
	public ExploreLogsController(AdminApplication app) {
		this.app = app;
		...
		parent.lookup("#close_btn").setOnMouseClicked(e -> app.updateSceneScene(ControllerDirectory.USER_MANGMENT));
	...
	private List<Acceso> obtenerLista(){
		...
		HttpRequest request = requestMan.open(SERVER_HOST + "/api/admin/log/" + from + "/" + to)
				.GET()
				.build();
